...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002167326042"))
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002606246845"))
FORCE_SUB_CHANNEL4 = int(os.environ.get("FORCE_SUB_CHANNEL4", "-1002316688746"))
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002440061111"))
...
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "a00fac3b631a5e240ad9fbd4b75be85dab6d0f52")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6011680723 5178714818 5749718252").split()):
        ADMINS.append(int(x))
except ValueError:
